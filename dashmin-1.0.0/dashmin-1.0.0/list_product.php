                ...
                <tbody>
                    <?php foreach ($products as $product) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="edit.php?id=<?php echo $product['id']; ?>&type=product">Edit</a>
                                <a class="btn btn-danger" href="delete.php?id=<?php echo $product['id']; ?>&type=product">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
